...
public class UserDaoImplMyBatisMapperInterfaceAnnotationMain2 {
	...
	public static void main(String[] args) throws Exception{
		...
		ApplicationContext applicationContext=
				new ClassPathXmlApplicationContext("com/itwill3/dao/3-4.user_dao_mybatis_mapper_interface_annotation2.xml");
